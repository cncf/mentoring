...
- Expected Outcome: Develop a new website using the Hugo framework based on the Figma layout design. It will replace the existing [ORAS documentation site](https://oras.land/) and provide a better user experience with interactive design.
