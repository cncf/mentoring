...
#### Support non-bgp switch for OpenELB

- Description: [OpenELB](https://github.com/openelb/openelb) is an open-source load balancer implementation designed for exposing the LoadBalancer type of Kubernetes services in bare metal, edge, and virtualization environments. We would like to make OpenELB supports configure the EIP route in the non-bgp switch by using Keepalived to maintain the vip and leverage lvs DR mode to enhance the forwarding performance.
- Recommended Skills: Kubernetes, Golang, Networking
- Mentor(s): [Yunkang Ren](https://github.com/renyunkang), [Feynman Zhou](https://github.com/gyohuangxin), [Zhengyi Lai](https://github.com/zheng1) 
- Upstream Issue (URL): https://github.com/openelb/openelb/issues/245

#### Develop the OpenELB Web UI for managing EIP and IP pool

- Description: [OpenELB](https://github.com/openelb/openelb) is an open-source load balancer implementation designed for exposing the LoadBalancer type of Kubernetes services in bare metal, edge, and virtualization environments. We would like to add a web console to manage EIP and IP pool and operate OpenELB configuration in an easy way.
- Recommended Skills: HTML/CSS/JavaScript, Kubernetes
- Mentor(s): [Yunkang Ren](https://github.com/renyunkang), [Feynman Zhou](https://github.com/gyohuangxin), [Zhengyi Lai](https://github.com/zheng1) 
- Upstream Issue (URL): https://github.com/openelb/openelb/issues/244
