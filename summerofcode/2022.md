...
- Expected Outcomes: The memoization feature is extended to allow additional storage systems.
...
- Expected Outcomes: An extension mechanism in Argo Workflows UI to embed custom UI elements.
- Expected Project Size: 175 hours
- Difficulty Rating: Medium
...
- Expected Outcomes: Support count-based enhanced depends logic in Argo Workflows in addition to the existing depends logic based on dependent tasks and their statuses.
- Expected Project Size: 175 hours
- Difficulty Rating: Medium
