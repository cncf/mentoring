...
- [DevStream](#devstream)
  - [Developer Tool Improvement](#developer-tool-improvement)
- [Knative](#knative)
...
- Description: DevStream wants to build a developer tool that can bootstrap your local dev env at the click of a button using interactive CLI. Currently we are doing MVP and market researches. We want to add more support regarding more programming languages and frameworks and CI/CD tools so that the users can bootstrap a new microservice using predefined template and setup the whole CI/CD pipelines locally.
- Expected outcome: creating PRs to support more languages, frameworks, and tools.
- Recommended Skills: Golang, understanding of popular programming languages and mainstream frameworks, knowledge of famous DevOps tools such as GitHub Actions, GitLab CI, FluxCD, etc.
- Mentor(s): Tiexin Guo @ironcore864 guotiexin@gmail.com, Daniel Hu @daniel-hutao tao.hu@merico.dev
- Expected project size: 8 Hours
- Difficulty: Easy
- Upstream Issue (URL): https://github.com/devstream-io/devstream/issues/1462
