...
- Expected outcome:
  - Develop a helper to achieve the goal that makes it easier for users to upgrade their projects.
  - Interfact with the community: make sure the roadmap is generally expected, continuously receive feedbacks to move forward the project.
  - Make the helpers properly covered with tests and documentation
  - Demostrate the feature into the community meeting
- Recommended Skills: Go
- Mentor(s): [Camila Macedo](https://github.com/camilamacedo86), [Varsha](https://github.com/varshaprasad96), [Tony (TianYi)](https://github.com/Kavinjsir)
- Expected project size: 350h
- Difficulty: Medium
- Design Proposal doc (URL): https://github.com/kubernetes-sigs/kubebuilder/blob/master/designs/helper_to_upgrade_projects_by_rescaffolding.md
