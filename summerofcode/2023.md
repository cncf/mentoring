...
- Expected outcome: Existence of one or more benchmark tests in the [lifecycle](https://github.com/buildpacks/lifecycle/) and/or [pack](https://github.com/buildpacks/pack/) repositories that can run as part of the Pull Request suite. After creating benchmarks, we can apply profiling to look for speedups, so the best possible outcome will also include documented user-facing performance improvements.
...
- Mentor(s): Natalie Arellano, Juan Jose Bustamente, Joe Kimmel
...
- Expected outcome: ARM executables can be built and released for one or more of the CLI tools in the CNB family (pack, imgutil, lifecycle, ...)
- Recommended Skills: Golang, software development literacy.
- Mentor(s): Natalie Arellano, Juan Jose Bustamente, Joe Kimmel
- Expected project size: 350 Hours
- Difficulty: Medium
- Upstream Issue (URL): https://github.com/buildpacks/pack/issues/1570
