...
- Mentor(s):  Ali Ok @aliok (aliok AT redhat DOT com), Christoph Stäbler @creydr
...
- Mentor(s): Matthias Wessendorf @matzew, Pierangelo Di Pilato @pierDipi
- Expected project size: 350h
- Difficulty: Medium
...
- Mentor(s): Reto Lehmann @ReToCode,  Stavros Kontopoulos @skonto
- Expected project size: 350h
- Difficulty: Hard
...
- Mentor(s): Pierangelo Di Pilato @pierDipi, Ali Ok @aliok
- Expected project size: 350h
- Difficulty: Hard
