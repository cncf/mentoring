...
#### Rewrite Litmus Portal authentication server and add third party intregration of google and github. 

- [litmuschaos](https://litmuschaos.io) is a Kubernetes native chaos engineering framework that helps SREs & developers find weaknesses in their deployments, with the chaos intent being defined via custom resources. The goal of this project is rewrite authencation server to make it modular and lightweight. Also add third party intregration of google, github. 
- Recommended Skills: Golang, Kubernetes, REST API
