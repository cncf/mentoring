...
tool reads it to generate the term folder's README timeline and to add the term
to [`../terms.yml`](../terms.yml), so the dates are entered once. Committed as
the term's schedule record.
